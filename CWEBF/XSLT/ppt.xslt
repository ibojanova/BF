				                ...
				                <p:nvGraphicFramePr> <p:cNvPr id="{position()}" name="tableCWEs"/> <p:cNvGraphicFramePr> <a:graphicFrameLocks noGrp="1"/> </p:cNvGraphicFramePr> <p:nvPr/> </p:nvGraphicFramePr>
					                ...
					                <a:graphic>
						                <a:graphicData uri="http://schemas.openxmlformats.org/drawingml/2006/table">
							                <a:tbl> <a:tblGrid> <a:gridCol w="1948834"/> <a:gridCol w="9230333"/> <a:gridCol w="17312032"/> </a:tblGrid>
								                <a:tr h="370840">
								                ...
								                <xsl:apply-templates mode="drawLegendTable" select="msxsl:node-set($myNodes)//W"/>
							                </a:tbl>
						                </a:graphicData>
					                </a:graphic>
				                </p:graphicFrame>
