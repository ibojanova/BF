...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" 
		...
		<xsl:variable name="attr">
			<xsl:choose>
				<xsl:when test="$useClassStyle">
					...
					<xsl:variable name="io" select="msxsl:node-set($showOtherCWEs)/*[CWE=current()/@Id]/@name"/>
					<xsl:copy-of select="msxsl:node-set($classStyles)/*[(@n = $class) or (@n = $io)]"/>
				</xsl:when>
				<xsl:otherwise>
	...
	<xsl:template mode="drawLegendTable" match="*">
		...
		<a:tr h="370840" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main">
			...
			<a:tc> <a:txBody><a:bodyPr/> <a:p> <a:r> 
				<a:rPr sz="{$legendTextSize}"> <xsl:choose> <xsl:when test="@Id = msxsl:node-set($showClassCWEs)//CWE"> <a:highlight> <a:schemeClr val="accent1"/> </a:highlight> </xsl:when> </xsl:choose> </a:rPr>
				<a:t> <xsl:value-of select="@N"/> </a:t> </a:r> </a:p> </a:txBody> <a:tcPr/> </a:tc>
			<a:tc> <a:txBody><a:bodyPr/> <a:p><a:r> 
				<a:rPr sz="{$legendTextSize}" > <xsl:choose> <xsl:when test="@Id = msxsl:node-set($showClassCWEs)//CWE"> <a:highlight> <a:schemeClr val="accent1"/> </a:highlight> </xsl:when> </xsl:choose> </a:rPr>
				<a:t> <xsl:value-of select="@D"/> </a:t> </a:r> </a:p> </a:txBody> </a:tc>
		</a:tr>
	</xsl:template>
	...
	<xsl:template mode="drawLegendNodes" match="*">
		...
		<p:grpSp xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main">
			...
			<p:grpSpPr>
				<a:xfrm>
					<a:off x="{$caption/@x}" y="{$caption/@y + 1200000*$pos}"/> <a:ext cx="16047523" cy="1200329"/> 
					<a:chOff x="30772678" y="44240717"/> <a:chExt cx="16047523" cy="1200329"/>
				</a:xfrm>
			</p:grpSpPr>
			<p:sp>
			...
			<p:sp>
				...
				<p:spPr> <a:xfrm> <a:off x="{32225704 - 2*$captionOff}" y="44490717"/> <a:ext cx="16047523" cy="1200329"/> </a:xfrm> </p:spPr>
